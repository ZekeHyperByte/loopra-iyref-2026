    ...
    return Column(
      ...
      children: [
        ...
        ...pickups.map((p) => Padding(
          padding: const EdgeInsets.only(bottom: 10),
          child: _buildPickupCard(context, p, state),
        )),
      ],
    );
  }

  Widget _buildPickupCard(BuildContext context, PickupRequest pickup, DemoState state) {
          ...
          if (pickup.driverName != null) ...[
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 6),
                Text(
                  '${pickup.estimatedWeightKg.toInt()} Kg',
                  style: const TextStyle(color: AppColors.muted, fontSize: 12),
                ),
              ],
            ),
